...
function g(r, t = {}) {
  const {
    ...
    // Adjusts the charm's sensitivity
    threshold: n = 0.1,
    // How much of the element needs to be visible to trigger the magic
    animationClass: m = "sb-fade-in"
    // The animation spell to cast
...
function x(r, t) {
  const {
    text: e,
    speed: n = 100,
    // ⚡ Speed of the Quick-Quotes Quill
    loop: m = !0,
    // 🔄 Whether the spell loops like a Time-Turner
    deleteDelay: s = 1500,
    // ⏳ Pause before vanishing the text
    typingDelay: l = 500,
    // ⏱️ Pause before starting the next spell
    cursorChar: c = "|"
    // ✨ The blinking wand tip
